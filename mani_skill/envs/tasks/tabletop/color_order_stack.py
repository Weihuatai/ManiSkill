...
@register_env("ColorOrderStack-v1", max_episode_steps=50)
class ColorOrderStackEnv(BaseEnv):
    """
    **Task Description:**
    The goal is to pick up a green cube and stack it on top of a red cube and let go of the cube without it falling
    ...
    **Success Conditions:**
    - the green cube is on top of the red cube (to within half of the cube size)
    - the green cube is static
    - the green cube is not being grasped by the robot (robot must let go of the cube)
    """
