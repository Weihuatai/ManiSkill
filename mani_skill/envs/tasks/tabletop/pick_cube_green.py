...
@register_env("PickCubeGreen-v1", max_episode_steps=50)
class PickCubeGreenEnv(BaseEnv):
    """
    **Task Description:**
    A simple task where the objective is to grasp a green cube and move it to a target goal position.
